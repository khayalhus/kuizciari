...
app.add_url_rule("/classes", view_func=views.semesters_page)
app.add_url_rule("/classes/<int:semester>", view_func=views.classes_page, methods=["GET", "POST"])
...
app.add_url_rule("/course/", view_func=views.courses_page, methods=["GET", "POST"])
